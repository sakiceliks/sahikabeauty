...
async function fetchBlogPosts() {
  try {
    ...
    const blogs = Array.isArray(data?.data) ? data.data.slice(0, 10) : []; // En fazla 10 blog yazısı
...
export default async function BlogPage() {
  ...
  return (
    <>
      ...
      <BlogClientPage
        blogPosts={blogPosts}
        error={blogPosts.success ? null : "Blog yazıları yüklenirken bir hata oluştu"}
        loading={false}
      />
    </>
  );
